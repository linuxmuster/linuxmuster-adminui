...
config['email']['templates'].setdefault('reset_email', '/etc/linuxmuster/adminui/email_templates/reset_email.html')
config.setdefault('logo', '/usr/lib/linuxmuster-adminui/plugins/lmn_common/resources/img/logo-full.png')

# Fix hyphen to underscore in previous versions
if config['email']['templates']['reset_email'] == '/etc/linuxmuster/adminui/email-templates/reset_email.html':
    config['email']['templates']['reset_email'] = '/etc/linuxmuster/adminui/email_templates/reset_email.html'
