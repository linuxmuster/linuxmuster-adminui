            ...
            let template = `
                <div class="text-center root-access-blocker">
                    ...
                    <h4 class="alert alert-danger" translate>
                        You should not use AdminUI as root user!<br />
                        If this is your first time running AdminUI, proceed through the <a href="/view/lmn/init/welcome">setup wizard</a>.<br />
